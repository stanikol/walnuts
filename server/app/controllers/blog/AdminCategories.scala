...
//  //      val submitTo = controllers.blog.routes.AdminCategories.adminGoodsCategoriesHandle
...
//  //      error => Future(Redirect(controllers.blog.routes.AdminCategories.adminGoodsCategoriesHandle)
...
//  //        }).map {
//  //          case (status, msg) =>
//  //            Redirect(controllers.blog.routes.AdminCategories.adminGoodsCategories).flashing(status -> msg)
//  //        }
//  //      }
//  //    )
//  //  }
...
//  //      val submitTo = controllers.blog.routes.AdminCategories.adminAlbumsCategoriesHandle
//  //      Ok(views.html.adminCategories(request.identity, categories, submitTo))
//  //    }
//  //  }
//  //
...
//  //    categoryForm.bindFromRequest().fold(
//  //      error => Future(Redirect(controllers.blog.routes.AdminCategories.adminAlbumsCategories)
//  //        .flashing("error" -> ("Инвалидные данные: " + error.errors.mkString("\n")))),
//  //      categoryEdit => {
//  //        val category = categoryEdit.category
//  //        (categoryEdit.action match {
...
//  //        }).map {
//  //          case (status, msg) =>
//  //            Redirect(controllers.blog.routes.AdminCategories.adminAlbumsCategories).flashing(status -> msg)
//  //        }
//  //      }
//  //    )
//  //  }
