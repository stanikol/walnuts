...
Main bootstrap name is now a partial (_bootstrap.scss), for compatibility with Compass 1+.
...
* Add `bootstrap-affix` to the Compass template name - *brief*
...
* Fix `rake:debug` with new name locations - *Thomas McDonald*
